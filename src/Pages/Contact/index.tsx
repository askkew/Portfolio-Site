import { ContactDiv, StyledGithubIcon, StyledLinkedInIcon, StyledEmailIcon, ContactCard, SocialButtons, NameTypograph, SubtitleTypograph, SubtitleTypograph2 } from "./ContactStyles";
